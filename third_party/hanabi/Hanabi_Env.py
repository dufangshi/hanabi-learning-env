...
class HanabiEnv(Environment):
    ...
    def vectorized_share_observation_shape(self):
        ...
        if self.obs_instead_of_state:
            ...
            # Note: ownhandshape is not available in standard Hanabi library
            # Using 0 since vectorized_ownhand is empty
            return [self.observation_encoder.shape()[0]]
    ...
    def _extract_dict_from_backend(self, player_id, observation):
        ...
        # Note: encodeownhand is not available in standard Hanabi library
        # Using empty array as placeholder for compatibility
        obs_dict["vectorized_ownhand"] = []
